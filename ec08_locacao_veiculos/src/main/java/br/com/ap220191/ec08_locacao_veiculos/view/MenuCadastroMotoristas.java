...
public class MenuCadastroMotoristas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBoxTipoHabilitacao.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "A", "B", "C", "D" }));
    ...
    private void jButtonCadastroMotoristaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadastroMotoristaActionPerformed
        if(jTextFieldNomeMotorista.getText().equals("") || jTextFieldMatriculaMotorista.getText().equals("")|| jTextFieldTempoMotorista.getText().equals("")){
