...
public class MenuCadastroMotoristaController {
    ...
    public void salvarMotorista() {
        ...
        Motorista motorista = new Motorista(view.getjTextFieldNomeMotorista().getText(), view.getjTextFieldMatriculaMotorista().getText(), view.getjComboBoxTipoHabilitacao(), view.getjTextFieldTempoMotorista().getText(), "true");
